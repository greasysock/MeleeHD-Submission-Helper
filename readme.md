...
4. Now that everything is setup, you can place any number of either *.pdf*,*.svg*, or *.ai* textures in the **submit** folder with the apropriate name, and start main.py ```python main.py```. All processed textures will be moved to **complete**
